...
// ———— PART 1 ———— //
enum Choice {SWITCHING, STOP};
Choice g_choice = SWITCHING;
//int g_characterIndex = 0;
//float g_frames_per_second_switching = 5.0f;
int g_animation_index = 0;
int g_animation_indices[4] = { 0, 1,2,3};
float g_animation_time = 0.0f;
int g_animation_frames = 4;
